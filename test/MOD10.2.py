...
def myNet(cname='controller', cargs='-v ptcp:'):
    ...
    s0.cmdPrint(
        'tc qdisc add dev s0-eth2 root handle 1: cbq avpkt 1000 bandwidth 10Mbit')
    s0.cmdPrint(
        'tc class add dev s0-eth2 parent 1: classid 1:1 cbq rate 512kbit allot 1500 prio 5 bounded isolated')
    s0.cmdPrint(
        'tc filter add dev s0-eth2 parent 1: protocol ip prio 16 u32 match ip src 192.168.123.1 flowid 1:1')
